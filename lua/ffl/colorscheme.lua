...
f.set_hl("NavicIconsNamespace", {fg = colors.fg, bg = colors.bg})
f.set_hl("NavicIconsPackage", {fg = colors.blue, bg = colors.bg})
f.set_hl("NavicIconsClass", {fg = colors.yellow, bg = colors.bg})
f.set_hl("NavicIconsMethod", {fg = colors.red, bg = colors.bg})
f.set_hl("NavicIconsProperty", {fg = colors.fg, bg = colors.bg})
...
f.set_hl("NavicIconsConstant", {fg = colors.fg, bg = colors.bg})
f.set_hl("NavicIconsString", {fg = colors.yellow, bg = colors.bg})
f.set_hl("NavicIconsNumber", {fg = colors.purple, bg = colors.bg})
f.set_hl("NavicIconsBoolean", {fg = colors.purple, bg = colors.bg})
f.set_hl("NavicIconsArray", {fg = colors.fg, bg = colors.bg})
f.set_hl("NavicIconsObject", {fg = colors.blue, bg = colors.bg})
f.set_hl("NavicIconsKey", {fg = colors.fg, bg = colors.bg})
f.set_hl("NavicIconsNull", {fg = colors.purple, bg = colors.bg})
...
f.set_hl("NavicIconsOperator", {fg = colors.fg, bg = colors.bg})
